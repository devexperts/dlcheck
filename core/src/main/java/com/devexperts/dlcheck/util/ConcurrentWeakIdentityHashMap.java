...
public class ConcurrentWeakIdentityHashMap<K, V> extends AbstractMap<K, V>
    ...
    static final class Segment<K,V> extends ReentrantLock implements Serializable {
        ...
        V get(Object key, int hash) {
            if (count != 0) { // read-volatile
                ...
                while (e != null) {
                    if (e.hash == hash && key == e.keyRef.get()) {
                        V v = e.value;
                        if (v != null)
                            return v;
        ...
        boolean replace(K key, int hash, V oldValue, V newValue) {
            ...
            try {
                removeStale();
                HashEntry<K,V> e = getFirst(hash);
                while (e != null && (e.hash != hash || !(key == e.keyRef.get())))
                    e = e.next;
     ...
     * @param m the map
     */
    public ConcurrentWeakIdentityHashMap(Map<? extends K, ? extends V> m) {
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            ConcurrentWeakIdentityHashMap.this.remove(currentKey);
            lastReturned = null;
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return ConcurrentWeakIdentityHashMap.this.containsValue(o);
        }
        public void clear() {
            ConcurrentWeakIdentityHashMap.this.clear();
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public boolean contains(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?,?> e = (Map.Entry<?,?>)o;
            V v = ConcurrentWeakIdentityHashMap.this.get(e.getKey());
